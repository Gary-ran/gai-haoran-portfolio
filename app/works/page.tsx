...
export default function WorksPage(){return <main><div className="shell"><SiteNav active="works"/>
  ...
  <section className="works-section vibe-section"><div className="works-section-head"><div><p>01 / VIBE CODING</p><h2>交互式项目</h2></div><span>点击项目，进入可操作的完整界面</span></div>
    ...
    <div className="vibe-grid">
      <Link className="vibe-card vibe-qc" href="/qc" prefetch><div className="vibe-thumb"><div className="thumb-window"><span>MULTIMODAL QC</span><i>LIVE</i></div><div className="thumb-qc-body"><aside><b>IMG-0142</b><b>VID-0087</b><b>VID-0101</b></aside><main><div className="thumb-frame"><em/><em/><em/></div><div className="thumb-bars"><i/><i/><i/><i/></div></main><section><strong>78</strong><span>待复核</span></section></div></div><div className="vibe-copy"><p>PROJECT 01</p><h3>多模态内容质检工作台</h3><span>六维评分、问题归因、Bad Case 队列与报告导出</span><b>打开完整项目 →</b></div></Link>
      <Link className="vibe-card vibe-eval" href="/eval" prefetch><div className="vibe-thumb"><div className="thumb-window"><span>BLIND EVALUATION</span><i>03 / 09</i></div><div className="thumb-eval-body"><div><span>A</span><p/><p/><p/></div><div className="active"><span>B</span><p/><p/><p/></div><div><span>C</span><p/><p/><p/></div></div><div className="thumb-ranking"><b>RANK 01 · CANDIDATE B</b><i>84</i></div></div><div className="vibe-copy"><p>PROJECT 02</p><h3>大模型回答双盲评测台</h3><span>统一 Query、匿名评分、五维比较与结果排名</span><b>打开完整项目 →</b></div></Link>
      <Link className="vibe-card vibe-interview" href="/interview" prefetch><div className="vibe-thumb"><div className="thumb-window"><span>INTERVIEW LAB</span><i>Q 03 / 05</i></div><div className="thumb-chat"><span>请说说你会从哪些维度判断 AI 生成视频的质量。</span><p>背景—任务—行动—结果</p><div><i/><i/><i/><i/></div><strong>82</strong></div></div><div className="vibe-copy"><p>PROJECT 03</p><h3>AI 岗位模拟面试工具</h3><span>岗位题库、规则评分、逐题反馈与总结报告</span><b>打开完整项目 →</b></div></Link>
      <Link className="vibe-card vibe-badcase" href="/badcases" prefetch><div className="vibe-thumb"><div className="thumb-window"><span>BAD CASE LIBRARY</span><i>08 CASES</i></div><div className="thumb-badcase-grid"><div><i>严重</i><b>主体变形</b><span>BC-001</span></div><div><i>一般</i><b>闪烁跳变</b><span>BC-002</span></div><div><i>严重</i><b>事实幻觉</b><span>BC-005</span></div><div><i>严重</i><b>安全边界</b><span>BC-008</span></div></div></div><div className="vibe-copy"><p>PROJECT 04</p><h3>AIGC Bad Case 案例库</h3><span>多模态异常检索、证据记录、基础归因与修复建议</span><b>打开完整项目 →</b></div></Link>
    </div>
